...
<script type="text/javascript">
    Kakao.init('f38379dc4a1fd8db1c81e44d5bf62547'); // REST API 키

    function kakaoLogin() {
        Kakao.Auth.login({
            success: function(authObj) {
                console.log(authObj);
                getKakaoUserInfo(authObj.access_token); // 사용자 정보 가져오기
            },
            fail: function(err) {
            ...
            success: function(response) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.success) {
                            window.location.href = "/index.jsp"; // 로그인 성공 후 리디렉션
                        } else {
                            alert('회원가입 처리 실패');
                        }
                    },

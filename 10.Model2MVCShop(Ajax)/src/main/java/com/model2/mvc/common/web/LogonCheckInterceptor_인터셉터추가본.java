 ...
 */
public class LogonCheckInterceptor_인터셉터추가본 extends HandlerInterceptorAdapter {

	///Field
	
	///Constructor
	public LogonCheckInterceptor_인터셉터추가본(){
	...
	public boolean preHandle(	HttpServletRequest request,
		...
		if(   user != null   )  {
			...
			if(		uri.indexOf("addUser") != -1        ||	
					uri.indexOf("login") != -1 			||	
		            uri.indexOf("checkDuplication") != -1 ||
		            uri.indexOf("listProduct") != -1      || // ⭐️ 상품 목록 허용
		            uri.indexOf("getProduct") != -1       || // ⭐️ 상품 상세 허용
		            uri.indexOf("index") != -1              // ⭐️ 메인 페이지 허용
		    ){
